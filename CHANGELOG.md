...
- Tweaked 'Debug Display' preference to use the game's save data instead of the mod's. No functional changes.
- Changed API version to 0.8.0 to make mod compatible with the LE SSERAFIM Collab Update.

# [1.0.0] - 2025-11-24

### Added

- Reimplemented the currently desktop only FPS Debug Display on mobile versions.
